...
class SpeechToText {
  ...
  ///
  /// [listenOptions] configures recognition behaviour such as cancelOnError,
  /// partialResults, onDevice, listenMode, and sampleRate. See
  /// [SpeechListenOptions] for details.
  Future listen(
